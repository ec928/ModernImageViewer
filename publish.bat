...
REM ============================================================================
REM  ModernImageViewer - build a portable, self-contained x64 release.
REM
...
REM  cold start (~2.8s to first window versus ~1.5s for loose files).
REM ============================================================================
...
echo ============================================================
echo  Publishing ModernImageViewer  (x64, self-contained, loose)
echo  Output: %OUTDIR%
echo ============================================================
echo.
